...
export interface Article {
  ...
  /**
   * Article thumbnail image (displayed in article cards and hero)
   */
  thumbnail?: (number | null) | CmsMedia;
  category:
    ...
    | 'legal_financial';
  /**
   * Which diagnosis stages this article applies to
   */
  diagnosisStages: ('early' | 'middle' | 'late' | 'unknown')[];
  /**
